...
var url_region = 'http://62.77.154.246:8080/geoserver/mastergis/wms';
var provinces=L.tileLayer.wms(url_region, {
		layers: 'mastergis:province',
		transparent: true,
		format: 'image/png',
		opacity:'0.8',
		zIndex: 2
	 ...
	 if (map.hasLayer(provinces)) {
		...
		var url = getFeatureInfoUrl(
										...
										e.latlng,
										{
												...
												'query_layers': 'mastergis:province',
...
// merge defaultParams and params that we'll declere next (Above)
